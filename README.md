# Home Assistant Add-on: Deauth Detector

The [Deauth Detector](https://github.com/TECH7Fox/deauth-detector-hass-addons) add-on for Home Assistant.
...
See the documentation [here](deauth-detector/DOCS.md).
